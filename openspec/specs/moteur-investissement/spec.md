# moteur-investissement

## Purpose

Définit le comportement des commandes « Placer / Retirer » du moteur d'investissement (bourse) :
les paliers de montants proposés au joueur, le plafonnement des transferts par les liquidités
(`eur`) ou le capital placé (`capital`), et l'état actif/inactif de chaque bouton selon les seuils.
